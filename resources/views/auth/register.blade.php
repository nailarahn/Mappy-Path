...
<div class="register-wrapper">
    ...
    <div class="register-left">
        ...
        <div class="left-content">
            <div class="left-tagline">Mulai perjalanan belajarmu hari ini! 🚀</div>
            <p class="left-sub">Bergabung bersama 1000+ siswa SMK TKJ yang sudah menggunakan Mappy Path.</p>
            <div class="benefit-list">
                ...
                <div class="benefit-item">
                    <div class="benefit-check">✓</div>
                    500+ materi video & artikel berkualitas
                </div>
                <div class="benefit-item">
                    <div class="benefit-check">✓</div>
    ...
    <div class="register-right">
        <div class="register-form-box">
            ...
            <p class="form-subtitle">Buat akunmu dan mulai belajar sekarang</p>
            ...
            <form method="POST" action="{{ route('register.post') }}">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        @error('username')
                            <div class="input-error">⚠ {{ $message }}</div>
                        @else
                            <div class="input-hint">Huruf kecil, angka, underscore</div>
                        @enderror
                    </div>
                </div>
                ...
                <div class="terms-row">
                    ...
                    <label for="terms">
                        ...
                        <a href="#">Kebijakan Privasi</a> Mappy Path
                    </label>
                </div>
